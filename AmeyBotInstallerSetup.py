...
def fileLoader():
    ...
    requirePips = sorted(["google-auth-httplib2", "google-api-python-client", "google-auth-oauthlib", "requests", "urllib3", "pybase64", "pillow", "pil-tools", "gtts", "pytchat", "pyjokes", "datetime", "wikipedia", "emoji", "pyttsx3", "playsound==1.2.2", "colorama", "pyfiglet", "winshell", "googletrans==4.0.0-rc1"])
